...
version: "1.0"
description: "Execute the six-phase spec-driven request flow so spec and code stay aligned. Use for any user request involving a change, feature, fix, refactor, or question, when starting a task that updates code or spec, when implementing a requirement, or when debugging spec-related behavior."
triggers:
